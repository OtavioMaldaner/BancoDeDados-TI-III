...
-- exercitar seu uso. 
SELECT DISTINCT departamento.Dnome FROM departamento WHERE EXISTS(SELECT funcionario.Sexo FROM funcionario WHERE funcionario.Sexo = 'F' AND funcionario.Dnr = departamento.Dnumero);
